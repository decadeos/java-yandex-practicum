...
public class Main {
    ...
    private static void generateDishCombo() {
        ...
        int maxPossible = dc.getMaxCombinations(selectedTypes);
        if (numberOfCombos > dc.getMaxCombinations(selectedTypes)) {
            System.out.println("Максимум комбинаций: " + maxPossible);
            System.out.println("Сгенерируем " + maxPossible + " вместо " + numberOfCombos + "\n");
            numberOfCombos = maxPossible;
        }
